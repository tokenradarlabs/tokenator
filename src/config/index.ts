...
const envSchema = z.object({
  ...
  COINGECKO_API_CACHE_COOLDOWN_SECONDS_MIN: z.coerce.number().int().min(60).default(60).describe('Minimum cooldown in seconds for CoinGecko API cache, defaults to 60 seconds'),
